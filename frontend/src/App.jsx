  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <ProtectedRoute allowedRoles={['HEI_ADMIN', 'FACULTY']}>
            <AppShell>
              <UniversityDashboard />
            </AppShell>
          </ProtectedRoute>
      ...
      <Route
        path="/university/proposals/new/:challengeId"
        element={
          <ProtectedRoute allowedRoles={['HEI_ADMIN']}>
            <AppShell>
              <ProposalFormPage />
            </AppShell>
          </ProtectedRoute>
      ...
      <Route
        ...
        element={
          <ProtectedRoute allowedRoles={['INDUSTRY_ADMIN']}>
            <AppShell>
              <IndustryDashboard />
            </AppShell>
          </ProtectedRoute>
      ...
      <Route
        path="/projects/:id/collaborate"
        element={
          <ProtectedRoute allowedRoles={['INDUSTRY_ADMIN']}>
            <AppShell>
              <ProjectDetailPage collaborationMode />
            </AppShell>
          </ProtectedRoute>
        }
      />
